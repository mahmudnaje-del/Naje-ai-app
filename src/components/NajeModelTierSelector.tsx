...
export const MODEL_TIERS: Record<ModelTier, ModelTierConfig> = {
  lite: {
    ...
    label: 'Naje Lite',
    badge: 'فائق السرعة',
    hint: 'الأسرع والأخفّ — تفكير منخفض ومباشر، مثالي للمهام السريعة.',
    multiplier: '0.6x',
    icon: TierLiteIcon,
  ...
  core: {
    ...
    hint: 'المتوازن — تفكير متوسط وذكاء متقدم يناسب معظم المهام.',
    multiplier: '1.0x',
    icon: TierCoreIcon,
  ...
  max: {
    ...
    label: 'Naje Max',
    badge: 'أعلى تفكير',
    hint: 'الأعمق — تفكير عالٍ واستنتاج منطقي قوي للمهام المعقدة.',
    multiplier: '2.0x',
    icon: TierMaxIcon,
...
export const IMAGE_MODELS: Record<ImageModelType, ImageModelConfig> = {
  lite: {
    ...
    badge: '0.5 نقطة',
    hint: 'خفيف وفائق السرعة، مناسب للأفكار والمسودات السريعة.',
    icon: TierLiteIcon,
    accentColor: 'text-amber-500 dark:text-amber-400',
    bgActive: 'bg-amber-500/10 border-amber-500/30 dark:bg-amber-500/15',
  },
  spectra: {
    ...
    hint: 'توازن مثالي بين الدقة العالية وسرعة التوليد وتفاصيل الألوان.',
    icon: TierCoreIcon,
    accentColor: 'text-indigo-600 dark:text-indigo-400',
    bgActive: 'bg-indigo-50 dark:bg-indigo-950/60 border-indigo-500/30',
  },
  nova: {
    ...
    hint: 'أقصى واقعية سينمائية ودقة متناهية في رسم التفاصيل والنصوص.',
    icon: TierMaxIcon,
    accentColor: 'text-purple-600 dark:text-purple-400',
    bgActive: 'bg-purple-50 dark:bg-purple-950/60 border-purple-500/30',
  },
...
export const VIDEO_MODELS: Record<VideoModelType, VideoModelConfig> = {
  veo: {
    ...
    hint: 'توليد سريع وسلس لحركات واقعية وطبيعية بجودة 720p/1080p.',
    icon: Film,
  ...
  'veo-pro': {
    ...
    hint: 'إخراج سينمائي فائق الدقة 1080p مع حركات كاميرا متقدمة وثبات عالي.',
    icon: TierMaxIcon,
