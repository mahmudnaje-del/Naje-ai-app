    ...
    <div className="flex flex-col gap-2 my-2 text-right" dir="rtl">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          title="تفاصيل التفكير ومجلس العقول"
          aria-label="تفاصيل التفكير ومجلس العقول"
          className="p-1.5 rounded-2xl bg-indigo-500/5 hover:bg-indigo-500/10 active:scale-95 transition-all cursor-pointer focus:outline-none select-none inline-flex items-center gap-2 group border border-indigo-500/15"
        >
          <img src={persona.icon} alt={persona.name} className="w-5 h-5 object-contain group-hover:scale-105 transition-transform" />
          <span className="text-[11px] font-bold text-indigo-950 dark:text-indigo-200">مجلس العقول — «{persona.name}» يفكّر...</span>
        </button>
      </div>
