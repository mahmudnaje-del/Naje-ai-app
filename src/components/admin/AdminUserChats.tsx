...
export default function AdminUserChats({
  ...
  const getModelBadgeForChat = (chat: ChatSession, msgs: Message[]) => {
    ...
    switch (chat.type) {
      case 'image': return 'gemini-3.1-flash-image / gemini-3-pro-image (Imagen 3)';
      case 'video': return 'veo-3.1-lite-generate-preview (Veo)';
      case 'ui': return 'gemini-3.5-flash-lite / gemini-3.7-flash (UI Studio)';
      case 'voice': return 'gemini-3.1-flash-tts-preview (Voice Engine)';
      case 'document': return 'gemini-3.5-flash-lite / gemini-3.7-flash (Doc Engine)';
      default: return 'gemini-3.7-flash';
    }
  };
