...
const MODEL_OPTIONS = [
  { id: 'video_standard', label: 'Veo 3.1 Standard (720p قياسي — موصى به)', provider: 'Google Veo' },
  { id: 'video_veo_lite', label: 'Veo 3.1 Lite (720p خفيف وسريع)', provider: 'Google Veo' },
];
